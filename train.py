...
class TrainModule(object):
    ...
    def train_network(self, args):
        ...
        save_path = os.path.join(args.save_dir, args.data_dir.split('/')[-2]+'_baseline')
    ...
    def dec_eval(self, args, dsets, epoch):
        ...
        result_path = os.path.join(args.save_dir, args.data_dir.split('/')[-2]+'_baseline', 'evalTxt_epoch_'+str(epoch)) 
        ...
        if 'dota' in args.dataset:
            merge_path = os.path.join(args.save_dir, args.data_dir.split('/')[-2]+'_baseline', 'evalTxt_merge_epoch_'+str(epoch))
